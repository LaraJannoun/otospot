                ...
                <table class="table align-items-center table-flush datatable">
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th scope="col">Arabic SubTitle</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ substr(strip_tags($row->title_en), 0, 20) }}...</td>
                            <td>{{ substr(strip_tags($row->title_ar), 0, 20) }}...</td>
                            <td>{{ substr(strip_tags($row->subtitle_en), 0, 50) }}...</td>
                            <td>{{ substr(strip_tags($row->subtitle_ar), 0, 50) }}...</td>
